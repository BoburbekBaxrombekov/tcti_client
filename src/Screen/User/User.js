...
function User({ setUserName, language }) {
    ...
    const {
        ...
        lang1, lang2, education1,  genderMale, genderWoman, send
    } = Ariza
                                ...
                                <div style={{ display: 'flex' }}>
                                    ...
                                    >
                                        <Upload multiple accept={'.pdf'} beforeUpload={(file) => {
                                            ...
                                            name="logo" action="http://185.217.131.80:4000/tolov/add" listType="picture">
